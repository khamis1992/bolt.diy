      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-bolt-elements-background-depth-2 rounded-lg shadow-lg border border-bolt-elements-borderColor">
        <div>
          ...
          <p className="mt-2 text-center text-bolt-elements-textSecondary">
            Or{' '}
            <Link to="/auth/signup" className="text-bolt-elements-link hover:underline">
        ...
        <Form method="post" className="mt-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me" className="ml-2 block text-sm text-bolt-elements-textSecondary">
                Remember me
              </label>
            </div>

            <div className="text-sm">
              <Link to="/auth/forgot-password" className="text-bolt-elements-link hover:underline">
